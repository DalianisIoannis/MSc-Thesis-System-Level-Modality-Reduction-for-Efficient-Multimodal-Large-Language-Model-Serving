...
_WORKLOADS_STATIC = {
    ...
    Workload(
        name="A-OKVQA Image Classification",
        path=os.path.join(WORKLOADS_DIR, "static"),
        alias="aokvqa_350",
        modalities="image",
        modality_pct=1.0
    ...
    Workload(
        name="A-OKVQA Grayscale Image Classification",
        path=os.path.join(WORKLOADS_DIR, "static"),
        alias="aokvqa-grayscale_350",
        modalities="image",
        modality_pct=1.0
    ),
    # Workload(
    #     name="A-OKVQA Image Classification 350_160_300_LANCZOS_95",
    #     path=os.path.join(WORKLOADS_DIR, "static"),
    #     alias="aokvqa_350_160_300_LANCZOS_95",
    #     modalities="image",
    #     modality_pct=1.0
    # ),
    Workload(
        name="A-OKVQA Image Classification Trial 30",
        path=os.path.join(WORKLOADS_DIR, "static"),
        alias="aokvqa_30",
        modalities="image",
        modality_pct=1.0
    ...
    Workload(
        name="A-OKVQA Image Classification Common Shapes 225",
        path=os.path.join(WORKLOADS_DIR, "static"),
        alias="aokvqa-common-shapes_225",
        modalities="image",
        modality_pct=1.0
    ),
    ###########################################################
